...
floorPath.removeClass("current-floor");
    //удаляем активный класс у этажей
    currentFloor = $(this).attr("data-floor");
    //получаем значение текущего этажа
    $(".counter").text(currentFloor); //записываем значение этажа в счетчик
});
floorPath.on("click", toggleModal);/*при клике на этаж открывает окно*/
modalCloseButton.on("click", toggleModal);/*приклике на крестик закрывает окно*/
